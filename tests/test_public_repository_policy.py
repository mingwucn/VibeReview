...
@pytest.mark.parametrize(
    ...
    [
        ...
        TreeEntry("100644", "0" * 40, "local-corpora/source.txt"),
        TreeEntry("100644", "0" * 40, "state/generations/000001/repository.json"),
        ...
        TreeEntry("100644", "0" * 40, "REVIEWS"),
        TreeEntry("100644", "0" * 40, "configs/Libraries"),
    ],
)
...
def test_retired_fixture_acceptance_phrases_are_absent() -> None:
    forbidden = (
        ...
        b"fully " + b"audited",
        b"systematic " + b"review",
        b"validation" + b"_passed",
    )
