...
PARENT_SECRET_VALUE = "sk-parent-only-5f4e3d2c1b0a99887766"
INJECTED_SECRET_VAR = "VIBEREVIEW_INJECTED_SECRET"
INJECTED_SECRET_VALUE = "sk-test-injected-0123456789abcdef"
CHUNK_SECRET_VALUE = "sk-test-chunk-boundary-9f8e7d6c5b4a3f2e1d0c"
...
def test_injected_secret_is_redacted_and_never_persisted(tmp_path):
    ...
    other = SyntheticCredentialProvider(
        secret_env={INJECTED_SECRET_VAR: "sk-test-different-secret-value"}
    )
    assert (
