"""Shared helpers for the prompt-infrastructure tests.

Kept in a uniquely named module (not ``conftest.py``) so test files can import
it deterministically regardless of collection order.
"""
