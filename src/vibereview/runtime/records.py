...
class AgentTask(RuntimeModel):
    ...
    input_dir: Path
    attempt_dir: Path
    # Runtime-only copy of the private trust anchor.  It exposes no private
    # path or source material and lets an engine adapter bind compilation to
    # the manifest that Python verified before invocation.
    expected_bundle_manifest_hash: Sha256 | None = None
...
class GenerationManifest(RuntimeModel):
    ...
    auxiliary_hash: Sha256 | None = None
